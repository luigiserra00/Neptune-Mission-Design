...
departure_date_lb = DateTime(2024,  1,  1).epoch()
departure_date_ub = DateTime(2026,  1,  1).epoch()
...
legs_tof_ub[0] = 600 * constants.JULIAN_DAY
# Earth fly-by
...
#legs_tof_ub[3] = 5500 * constants.JULIAN_DAY
